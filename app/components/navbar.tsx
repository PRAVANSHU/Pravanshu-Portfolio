...
const Navbar =() => {
 ...
 const scrollToSection = useCallback((sectionId: string) =>{
    ...
    return (
        ...
        <button className="bg-background card-shadow md:hidden p-3 rounded" onClick={()=>setIsOpen((prevVal)=> !prevVal)}>
        ...
        <nav className={cn("bg-background card-shadow p-3 rounded md:block duration-300 ease-in-out",{
            ...
            <ul className="flex flex-col items-center gap-4 text-lg font-serif md:flex-row">
                <li>
                    <div className={cn("rounded p-1 duration-300 ease-in-out",{"bg-primary text-white":
                    activeSection === "home",})}
                        onClick={() => {
                            setActiveSection("home");
                ...
                <li>
                    <div className={cn("rounded p-1 whitespace-nowrap duration-300 ease-in-out",{"bg-primary text-white":
